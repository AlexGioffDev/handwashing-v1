    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 15, 8, 330);
    			attr_dev(div0, "class", "progress-bar svelte-yf0v46");
    			set_style(div0, "width", "20%");
    			add_location(div0, file$3, 14, 6, 275);
    			attr_dev(div1, "bp", "offeset-5@md 4@md 12@sm");
    			attr_dev(div1, "class", "progress-container svelte-yf0v46");
    			add_location(div1, file$3, 13, 2, 207);
    			attr_dev(div2, "bp", "grid");
    			add_location(div2, file$3, 12, 0, 189);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "bp", "offeset-5@md 4@md 12@sm");
    			attr_dev(h2, "class", "svelte-158a00w");
    			add_location(h2, file$2, 16, 2, 224);
    			attr_dev(div, "bp", "grid");
    			add_location(div, file$2, 15, 0, 206);
    			attr_dev(button, "class", "start svelte-158a00w");
    			add_location(button, file$2, 23, 0, 310);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
