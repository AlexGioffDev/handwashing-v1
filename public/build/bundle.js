...
var app = (function () {
    ...
    /* src/ProgressBar.svelte generated by Svelte v3.57.0 */
    ...
    /* src/Timer.svelte generated by Svelte v3.57.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	progressbar = new ProgressBar({
    			props: { progress: /*progressValue*/ ctx[2] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*startTimer*/ ctx[3], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*progressValue*/ 4) progressbar_changes.progress = /*progressValue*/ ctx[2];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('progressValue' in $$props) $$invalidate(2, progressValue = $$props.progressValue);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondLeft*/ 1) {
    			$$invalidate(2, progressValue = (totalSeconds - secondLeft) / totalSeconds * 100);
    		}
    	};

    	return [secondLeft, isRunning, progressValue, startTimer];
    }
    ...
    /* src/HowTo.svelte generated by Svelte v3.57.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = "handwashing.gif")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "How to wash your hands.");
    			attr_dev(img, "class", "svelte-1wsp3u5");
    			add_location(img, file$1, 8, 2, 66);
    			attr_dev(div, "bp", "grid");
    			add_location(div, file$1, 6, 0, 47);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1fomk7m");
    			add_location(h1, file, 19, 0, 220);
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "href", "https://www.who.int/gpsc/clean_hands_protection/en/");
    			add_location(a0, file, 26, 2, 294);
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "href", "https://freesound.org/people/metrostock99/sounds/345086/");
    			add_location(a1, file, 27, 2, 393);
    			attr_dev(h3, "class", "svelte-1fomk7m");
    			add_location(h3, file, 25, 0, 287);
    			if (!src_url_equal(source.src, source_src_value = "sound.wav")) attr_dev(source, "src", source_src_value);
    			add_location(source, file, 31, 2, 528);
    			add_location(audio_1, file, 30, 0, 500);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
